...
knitr::opts_chunk$set(fig.path = 'images/analyser/inter/acm/')
```
...
En premier lieu, comme dans le [chapitre sur la régression logistique](analyser_inter_reg_log.html), 
