...
**R** est distribué avec un _package_ qui permet de moins avoir à bricoler les graphiques : <strong class="package">lattice</strong>. Mais surtout, **R** est aussi capable de comprendre la <q>grammaire graphique</q> [théorisée par Leland Wilkinson](https://books.google.fr/books/about/The_Grammar_of_Graphics.html), et traduite pour **R** par Hadley Wickham sous la forme du _package_ <strong class="package">[ggplot2](http://ggplot2.org/)</strong>. Ce chapitre présente ces deux _packages_ à partir d'un exemple simple de visualisation de séries temporelles, puis rentre dans le détail de la syntaxe de <strong class="package">ggplot2</strong>^[Bien que l'on ait fait le choix de présenter le détail du _package_ <strong class="package">ggplot2</strong> plutôt que du _package_ <strong class="package">lattice</strong>, ce dernier reste un excellent choix pour la visualisation, notamment, de [panels](http://www.magesblog.com/2013/09/using-planelgroups-in-lattice.html) et de [séries temporelles](http://www.fromthebottomoftheheap.net/2013/10/23/time-series-plots-with-lattice-and-ggplot/). On trouve de [très beaux exemples](https://procomun.wordpress.com/2015/04/14/mapping-flows-in-r-with-data-table-and-lattice/) d'utilisation de <strong class="package">lattice</strong> en ligne, mais un peu moins de documentation, et beaucoup moins d'extensions, que pour <strong class="package">ggplot2</strong>.].
...
<div class="important">
Aussi élégants que soient vos graphiques, il ne vous dispense évidemment pas de réfléchir à ce que vous êtes en train de visualiser, un graphique très élégant pouvant naturellement être complètement erroné !
</div>

## Composition graphique avec <strong class="package">ggplot2</strong>
...
<div class="note">
Le paramètre `facet_grid`{data-package="ggplot2" data-rdocumentation="facet_grid"} permet de créer des facettes plus compliquées que celles créées par le paramètre `facet_wrap`{data-package="ggplot2" data-rdocumentation="facet_wrap"}. On s'en sert ici pour illustrer son fonctionnement, qui utilise aussi la notation <q>équation</q>.
</div>
...
## Documentation sur <strong class="package">ggplot2</strong>
...
- le _package_ <strong class="package">[ggfortify](https://github.com/sinhrks/ggfortify)</strong> permet de visualiser les résultats de différentes fonctions de modélisation avec <strong class="package">ggplot2</strong> ;
- le _package_ <strong class="package">[ggmap](http://cran.r-project.org/web/packages/ggmap/)</strong> permet de visualiser des fonds de carte et d'y superposer des éléments graphiques rédigés avec <strong class="package">ggplot2</strong> ;
- le _package_ <strong class="package">[GGally](http://cran.r-project.org/web/packages/GGally/)</strong> rajoute quelques types de graphiques à ceux que <strong class="package">ggplot2</strong> peut produire par défaut ;
- et des _packages_ comme <strong class="package">[ggvis](http://ggvis.rstudio.com/)</strong> permettent de produire des graphiques interactifs en utilisant la syntaxe de base de <strong class="package">ggplot2</strong>.
