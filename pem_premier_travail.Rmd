...
<dfn data-index="variable">variables</dfn>. Les fonctions `nrow`{data-package="base"}, 
...
La troisième se nomme *sexe*, il s'agit d'un <dfn>facteur</dfn> (<dfn lang="en">factor</dfn>).
