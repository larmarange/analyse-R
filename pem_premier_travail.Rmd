...
`ncol`{data-pkg="base" data-rdocumentation="nrow"} et `dim`{data-pkg="base"} donnent respectivement 
...
La fonction `str`{data-pkg="utils"} est plus complète. Elle liste les différentes variables, 
...
`$`{data-pkg="base" data-rdocumentation="Extract"}, suivi du nom de la variable,
comme ceci :
...
Les fonctions `head`{data-pkg="utils"} et `tail`{data-pkg="utils" data-rdocumentation="head"}
