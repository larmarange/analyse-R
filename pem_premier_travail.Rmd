...
<em class="concept">script</em><em class="concept" data-index="fichier de commandes"></em>.
...
Un <em class="concept">commentaire</em> est une ligne ou une portion de ligne 
...
<em class="concept" data-index="section">sections</em> au sein 
...
<em class="concept" data-index="data frame">data frames</em>, ou 
<em class="concept" data-index="tableau de donnée">tableaux de données</em>.
...
Un tableau de données est organisé en lignes et en colonnes, les lignes correspondant aux 
<em class="concept" data-index="observation">observations</em>et les colonnes aux 
<em class="concept" data-index="variable">variables</em>. Les fonctions `nrow`{data-package="base"}, 
...
20 variables. Vient ensuite la liste des variables. La première se nomme *id* et est de type 
<em class="concept">entier</em> (*int*<em class="concept" data-index="integer"></em>). 
La seconde se nomme *age* et est de type 
<em class="concept" data-index="numérique, variable">numérique</em>
<em class="concept" data-index="variable numérique"></em><em class="concept" data-index="numeric"></em>. 
La troisième se nomme *sexe*, il s'agit d'un <em class="concept">facteur</em> (<em class="concept">factor</em>).

Un facteur est une variable pouvant prendre un nombre limité de 
<em class="concept" data-index="modalité, facteur">modalités</em> 
(<em class="concept" data-index="level, factor">levels</em>). Ici notre variable
...
type d'objet. C'est un excellent moyen de connaître la 
<em class="concept">structure d'un objet</em>.
</div>
...
Sous **RStudio**, on peut aussi afficher la <em class="concept">visionneusee</em> 
(<em class="concept">viewer</em>) en cliquant sur la petite icône en forme 
