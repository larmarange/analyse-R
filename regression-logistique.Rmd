...
`svrepmisc`{.pkg} fournit également des méthodes `confint` et `tidy`{data-pkg="svrepmisc" data-rdoc="tidy.svrepstatmisc"}. Il est également possible d'utiliser `ggcoef`{data-pkg="GGally"}.
