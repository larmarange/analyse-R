...
Pour un modèle multinomial ou ordinal, on pourra se référer à <https://rpubs.com/corey_sparks/58926>. Il existe cependant une version simplifier des modèles ordinaux disponible dans <strongclass="pkg">surevy</survey> via la fonction `svyolr`{data-pkg="survey"}.
