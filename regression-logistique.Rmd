...
Une version améliorée `ggcoef_model`{data-pkg="GGally"} est disponible dans la version de développement^[Cette version de développement peut être installée avec la commande `devtools::install_github("ggobi/ggally")`.] de `GGally`{.pkg} en ayant recours à `broom.helpers`.
