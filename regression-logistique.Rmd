...
Pour un modèle multinomial ou ordinal, on pourra se référer à <https://rpubs.com/corey_sparks/58926>. Il existe cependant une version simplifiée des modèles ordinaux disponible dans <strong class="pkg">surevey</strong> via la fonction `svyolr`{data-pkg="survey"}.
