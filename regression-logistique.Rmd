...
Pour un modèle ordinal, il existe cependant une version simplifiée des modèles ordinaux directement disponible dans <strong class="pkg">survey</strong> via la fonction `svyolr`{data-pkg="survey"}.
