...
<strong class="pkg">svrepmisc</strong> fournit également des méthodes `confint` et `tidy`{data-pkg="svrepmisc" data-rdoc="tidy.svrepstatmisc"}. Il est également possible d'utiliser `ggcoef`{data-pkg="GGally"}.
...
L'extension <strong class="pkg">JLutils</strong>^[`devtools::install_github("larmarange/JLutils")` pour l'installer] propose une méthode `tidy`{data-pkg="JLutils" data-rdoc="tidy_model"} pour les objets `svyolr.`
