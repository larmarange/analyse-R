...
Avec la fonction `plot`{data-pkg="stats" data-rdocumentation="dendrogram"}, 
...
(agriculteur, étudiant, etc.). Ce graphique s'obtient avec `seqdplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"} :
...
(<dfn lang="en">index plots</dfn>), obtenus avec `seqiplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"},
...
`seqfplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"}.
...
On peut aussi visualiser avec `seqmsplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"}
...
On peut également représenter avec `seqmtplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"}
...
Ce type de graphique produit par `seqHtplot`{data-pkg="TraMineR" data-rdocumentation="seqplot"}
