...
(<dfn lang="en">index plots</dfn>), obtenus avec `seqiplot`{data-package="TraMineR" data-rdocumentation="seqplot"},
...
la fonction `cmdscale`{data-package="stats"}).
...
Le package <strong class="package">JLutils</strong>, disponible sur 
...
`disscenter`{data-package="TraMineR"}, permet de mesurer plus précisément 
