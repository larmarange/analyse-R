...
le package <strong class="pkg">TraMineR</strong>^[<http://mephisto.unige.ch/traminer/>],
...
<strong class="pkg">TraMineR</strong> propose de nombreuses fonctions pour l'analyse de séquences. 
L'extension <strong class="pkg">cluster</strong> comprend un certain nombre de méthodes de 
...
<strong class="pkg">TraMineR</strong>
...
Le package <strong class="pkg">JLutils</strong>, disponible sur 
