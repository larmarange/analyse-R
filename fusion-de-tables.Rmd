...
<div class="important">
Pour éviter toute erreur, il est préférable de ne jamais utiliser `cbind`{data-pkg="base"} ou son équivalent `bind_cols`{data-pkg="dplyr" data-rdoc="bind"} fourni par `dplyr`{.pkg}.
