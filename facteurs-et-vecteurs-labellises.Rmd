...
La méthode `mean`{data-pkg="labelled" data-rdoc="mean.labelled"} ayant été définie pour les vecturs
labellisées dans l'extension <strong class="pkg">labelled</strong>, il est également possible de faire
directement :


```{r}
mean(notes, na.rm = TRUE, missing_to_na = TRUE)
```
