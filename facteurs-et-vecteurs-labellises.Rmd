...
<div class="guide-R">
Une version actualisée de ce chapitre est disponible sur **guide-R** : [Facteurs et forcats](https://larmarange.github.io/guide-R/manipulation/facteurs.html), [Étiquettes de variables](https://larmarange.github.io/guide-R/manipulation/etiquettes-variables.html), [Étiquettes de valeurs](https://larmarange.github.io/guide-R/manipulation/etiquettes-valeurs.html) & [Valeurs manquantes](https://larmarange.github.io/guide-R/manipulation/valeurs-manquantes.html)
</div>
...
Les fonctions `look_for`{data-pkg="labelled"} de l'extension `laballed`{.pkg} et `describe`{data-pkg="questionr"} de l'extension `questionr`{.pkg} affichent également les étiquettes de variables lorsqu'elles existent.
...
L'[import de données labellisées](import-de-donnees.html) et le [recodage de variables](recodage.html#labelled) (dont la conversion d'un vecteur labellisé en facteur) seront quant à eux abordés dans les prochains chapitres.
