...
par les différents moyens disponibles (voir le chapitre [Où trouver de l'aide ?](manipuler_pem_aide.html))
...
(voir le [chapitre dédié](manipuler_pem_organiser.html)). Concernant les données
...
déroulé (voir la section [Inspecter les données](manipuler_pem_travail.html#inspecter) du chapitre
