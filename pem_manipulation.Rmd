...
peut soit faire commencer la première classe à 16, soit utiliser l'option `include.lowest=TRUE` :
...
recodée et celles ayant servi au recodage, à l'aide de la fonction `table`{data-package="base"},
et de vérifier le nombre de valeurs manquantes dans la variable recodée 
...
La fonction `sort`{data-package="base"} permet de trier les éléments d'un vecteur.
...
Une opération relativement courante consiste à fusionner plusieurs tables pour regrouper tout ou
