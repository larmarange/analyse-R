...
`rename.variable`{data-package="questionr"} de l'extension <strong class="pkg">questionr</strong>. 
...
La fonction `addNAstr`{data-package="questionr"} de l'extension <strong class="pkg">questionr</strong>
...
Dans le cas présent, l'extraction obtenue avec `subset`{data-package="base"} est
équivalente à :
...
Cette notation étant un peu lourde, on peut l'alléger un peu en utilisant la fonction `ifelse`{data-package="base"}.
