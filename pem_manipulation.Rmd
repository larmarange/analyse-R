...
`$`{data-pkg="base" data-rdocumentation="Extract"}.

Dans ce qui suit on travaillera sur le jeu de données tiré de l'enquête *Histoire de vie*, fourni avec
l'extension <strong class="pkg">questionr</strong>, mais aussi sur le jeu de données tiré du 
...
`rename.variable`{data-pkg="questionr"} de l'extension <strong class="pkg">questionr</strong>. 
...
<div class="astuce">
L'extension <strong class="pkg">questionr</strong> propose une *interface interactive* pour 
...
`addNA`{data-pkg="base" data-rdocumentation="factor"}. 
...
La fonction `addNAstr`{data-pkg="questionr"} de l'extension <strong class="pkg">questionr</strong>
...
L'opérateur `%in%`{data-pkg="base" data-rdocumentation="match"} peut être très utile : 
...
On utilisera à la place la fonction *ad hoc* `is.na`{data-pkg="base" data-rdocumentation="NA"}.
...
de la fonction `as.character`{data-pkg="base" data-rdocumentation="character"} :
...
variable numérique avec la fonction `as.numeric`{data-pkg="base" data-rdocumentation="numeric"}. 
...
<div class="attention">
Lorsque l'on convertit un facteur avec `as.numeric`{data-pkg="base" data-rdocumentation="numeric"},
...
<div class="astuce">
L'extension <strong class="pkg">questionr</strong> propose une interface interactive à la fonction 
...
L'extension <strong class="pkg">questionr</strong> propose aussi une fonction 
...
`as.character`{data-pkg="base" data-rdocumentation="character"} :
...
`is.na`{data-pkg="base" data-rdocumentation="NA"} :
...
<div class="astuce">
<strong class="pkg">questionr</strong> propose une interface interactive pour le recodage 
...
`rbind`{data-pkg="base" data-rdocumentation="cbind"}.].
