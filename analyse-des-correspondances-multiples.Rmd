...
<div class="note">
L'extension <strong class="pkg">explor</strong> écrite par Julien Barnier offre une interface graphique interactive permettant d'explorer les résultats d'une analyse factorielle. Essayons donc la fonction `explor`{data-rdoc="explor"}. C'est magique !
