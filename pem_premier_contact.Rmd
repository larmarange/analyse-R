...
Que signifie cette commande ? L'opérateur `<-`{data-pkg="base" data-rdocumentation="assignOps"} est appelé 
...
fonction `var`{data-pkg="stats" data-rdocumentation="cor"} sa variance.
...
| `var`{data-pkg="stats" data-rdocumentation="cor"} | variance d'un vecteur de type numérique |
| `+`{data-pkg="base" data-rdocumentation="Arithmetic"}, `-`{data-pkg="base" data-rdocumentation="Arithmetic"}, `*`{data-pkg="base" data-rdocumentation="Arithmetic"}, `/`{data-pkg="base" data-rdocumentation="Arithmetic"} | opérateurs mathématiques de base |
| `ˆ`{data-pkg="base" data-rdocumentation="Arithmetic"} | passage à la puissance |

On peut rajouter les fonctions de base suivantes :

| Fonction | Description |
|:---------|:------------|
| `min`{data-pkg="base" data-rdocumentation="Extremes"} | valeur minimale d'un vecteur numérique |
| `max`{data-pkg="base" data-rdocumentation="Extremes"} | valeur maximale d'un vecteur numérique |
| `sd`{data-pkg="stats"} | écart-type d'un vecteur numérique |
| `:`{data-pkg="base" data-rdocumentation="Colon"} | génère une séquence de nombres. `1:4` équivaut à `c(1,2,3,4)` |
...
avec `?`{data-pkg=="utils" data-rdocumentation=="Question"} ou `help`{data-pkg="utils"}. Ainsi,
...
<div class="note">
L'utilisation du raccourci `?`{data-pkg=="utils" data-rdocumentation=="Question"} ne fonctionne 
pas pour certains opérateurs comme `*`{data-pkg="base" data-rdocumentation="Arithmetic"}. 
