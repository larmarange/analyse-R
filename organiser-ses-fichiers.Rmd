...
Si vous débutez avec **R**, laissez de côté pour le moment les gestionnaires de versions qui sont destinés aux utilisateurs avancés (et présentés dans le chapitre [Git](git.html)). Dans le cadre d'un usage courant, on aura recours à *New Directory*.
