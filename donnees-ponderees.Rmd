...
<div class="note">
L'extenstion `JLutils` propose une fonction `ggsurvey`{data-pkg="JLutils"} pour faciliter les choses. Elle prend un objet `survey`, extrait le tableau de données et les poids, associe les poids à l'esthétique correspondante et appelle `ggplot`{data-pkg="ggplot2"}.
...
`JLutils`{.pkg} n'est disponible que sur GitHub. Pour l'installer, on pourra utiliser la commande suivante :
