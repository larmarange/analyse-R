...
<div class="guide-R">
Une version actualisée de ce chapitre est disponible sur **guide-R** : [Import & Export de données](https://larmarange.github.io/guide-R/manipulation/import-export.html)
</div>
...
<div class="note">
Une première alternative est l'extenstion `openxlsx`{.pkg} et sa fonction `read.xlsx`{data-pkg="openxlsx"}.

Une seconde alternative est l'extension `xlsx`{.pkg} qui propose deux fonctions
...
La section [Database Management](https://github.com/qinwf/awesome-R#awesome-r-database-management) du site *Awesome R* fournit également une liste d'extensions permettant de s'interfacer avec différents gestionnaires de bases de données.
