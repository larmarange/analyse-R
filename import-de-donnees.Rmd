...
Pour la suite de la démonstration, nous allons utiliser le ficheir exemple
...
Pour les données **SQL**, on pourra utiliser les fonctionnalités de `dplyr`{.pkg} dans ce domaine, voir <https://cran.rstudio.com/web/packages/dplyr/vignettes/databases.html>.
