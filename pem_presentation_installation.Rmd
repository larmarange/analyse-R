...
la plupart s'intègre parfaitement avec **RStudui*. On nomme un peu familièrement 
*Hadleyverse* l'ensemble constitué par les différentes extensions crées par Hadley Wickham.
...
les extensions proposées par Hadley Wickham, en particulier `haven`{.pkg}, `readr`{.pkg} et
...
pour la gestion des dates ou encore `stringr`{.pkg} pour la manipulation de chaînes de
caractères.
...
Pour mettre à jour **R** sous **Windows**<dfndata-index="mise à jour, R"></dfn>, 
