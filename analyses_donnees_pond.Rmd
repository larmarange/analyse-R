...
`cprop`{data-package="questionr"} de <strong class="pkg">questionr</strong> sont donc 
...
Enfin, <strong class="pkg">survey</strong> fournit une fonction `svyglm`{data-package="survey"}
