...
l'[analyse des correspondances](analyses_acm.html).] des extensions <strong class="package">ade4</strong>
...
* `svymean`{data-package="survey" data-rdocumentation="surveysummary"}, 
  ...
  `svyquantile`{data-package="survey"} : <dfn data-index="statistique univariée">statistiques univariées</dfn>
...
* `svytable`{data-package="survey"} : <dfn>tri à plat</dfn> et <dfn>tableau croisé</dfn>
* `svychisq`{data-package="survey" data-rdocumentation="svytable"} : <dfn data-index="test du Chi²">test du &chi;²</dfn>
  <dfn data-index="Chi², test"></dfn>
* `svyby`{data-package="survey"} : statistiques selon un facteur
* `svyttest`{data-package="survey"} : <dfn>test t de Student</dfn><dfn data-index="Student, test-t"></dfn>
  de <dfn>comparaison de moyennes</dfn><dfn data-index="moyenne, comparaison"></dfn>
* `svyglm`{data-package="survey"} : <dfn data-index="modèle linéaire généralisé">modèles linéaires généralisés</dfn>
...
s'obtient avec `confint`{data-package="survey" data-rdocumentation="surveysummary"}
...
avec `svyciprop`{data-package="survey"}.
...
Le principe de la fonction `svyby`{data-package="survey"} est similaire à celui de 
...
`AIC.svyglm`{data-package="survey" data-rdocumentation="anova.svyglm"} permettant d'estimer un <dfn>AIC</dfn>
sur un modèle calculé avec `svyglm`{data-package="survey"}. Il est dès lors possible d'utiliser 
la fonction `step`{data-package="stats"} pour réaliser une 
...
La fonction `svydesign`{data-package="survey"} accepte plusieurs arguments décrits sur sa page 
...
consiste à utiliser `as.integer`{data-package="base"} pour obtenir le code des facteurs et non leur valeur textuelle. 
