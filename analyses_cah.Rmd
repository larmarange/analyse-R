...
ATTENTION : cette version n'implémente que la version « classique » de la méthode Ward. Il faut donc 
manuellement indiquer que l'on souhaite utiliser le carré des distances avec `md^2`.
</div>
