...
`daisy`{data-pkg="cluster"} de l'extension <strong class="pkg">cluster</strong>. Enfin, dans le 
chapitre sur l'[analyse de séquences](analyses_seq.html), nous verrons également la fonction 
`seqdist`{data-pkg="TraMineR"} (extension <strong class="pkg">TraMineR</strong>) permettant de
...
**R** avec la fonction `daisy`{data-pkg="cluster"} du package <strong class="pkg">cluster</strong>.
...
Nous allons reprendre l'ACM calculée avec `dudi.acm`{data-pkg="ade4"} (<strong class="pkg">ade4</strong>)
...
Le dendrogramme obtenu peut être affiché simplement avec `plot`{data-pkg="stats" data-rdocumentation="hclust"}.
...
La fonction `agnes`{data-pkg="cluster"} de l'extension <strong class="pkg">cluster</strong> peut également 
...
transformer un objet `agnes`{data-pkg="cluster" data-rdocumentation="agnes.object"} au format 
`hclust`{data-pkg="stats"} avec `as.hclust`{data-pkg="cluster" data-rdocumentation="agnes.object"}.
...
<strong class="pkg">devtools</strong> et à sa fonction `install_github`{data-pkg="devtools"} :
...
L'extension <strong class="pkg">FactoMineR</strong> fournit une fonction `HCPC`{data-pkg="FactoMineR"}
...
On pourra représenter le dendrogramme avec `plot`{data-pkg="FactoMineR" data-rdocumentation="plot.HCPC"}
