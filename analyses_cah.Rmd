...
Avec l'extension <strong class="pkg">ade4</strong>, la distance du &Phi;² s'obtient avec la fonction 
...
Le cas particulier de la CAH avec l'extension <strong class="pkg">FactoMineR</strong> sera abordée dans 
...
`daisy`{data-package="cluster"} de l'extension <strong class="pkg">cluster</strong>. Enfin, dans le 
chapitre sur l'[analyse de séquences](analyses_seq.html), nous verrons également la fonction 
`seqdist`{data-package="TraMineR"} (extension <strong class="pkg">TraMineR</strong>) permettant de
...
**R** avec la fonction `daisy`{data-package="cluster"} du package <strong class="pkg">cluster</strong>.
...
Nous allons reprendre l'ACM calculée avec `dudi.acm`{data-package="ade4"} (<strong class="pkg">ade4</strong>)
...
L'extension <strong class="pkg">fastcluster</strong> permet de réduire significativement le temps de calcul.
...
La fonction `agnes`{data-package="cluster"} de l'extension <strong class="pkg">cluster</strong> peut également 
...
L'extension <strong class="pkg">FactoMineR</strong> (que nous aborderons 
...
L'extension <strong class="pkg">JLutils</strong> 
...
Pour installer <strong class="pkg">JLutils</strong>, on aura recours au package 
<strong class="pkg">devtools</strong> et à sa fonction `install_github`{data-package="devtools"} :
...
<strong class="pkg">JLutils</strong>.
...
On pourra aussi noter l'extension <strong class="pkg">ggdendro</strong> pour représenter
des dendrogrammes avec <strong class="pkg">ggplot2</strong> ou encore l'extension
<strong class="pkg">dendextend</strong> qui permet de manipuler, représenter et
...
L'extension <strong class="pkg">FactoMineR</strong> fournit une fonction `HCPC`{data-package="FactoMineR"}
...
des distances. On peut reproduire cela avec <strong class="pkg">FactoMineR</strong> en indiquant 
