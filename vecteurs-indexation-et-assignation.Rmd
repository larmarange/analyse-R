...
<div class="guide-R">
Une version actualisée de ce chapitre est disponible sur **guide-R** :
[Vecteurs](https://larmarange.github.io/guide-R/bases/vecteurs.html)
</div>
...
Dans ce chapitre, nous reviendrons sur les vecteurs, tandis que les listes et les tableaux de données seront abordés dans un [chapitre dédié](listes-et-tableaux-de-donnees.html).
