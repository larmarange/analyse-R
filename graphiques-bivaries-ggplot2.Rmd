...
`ggbivariate`{data-pkg="GGally"} quant à elle affiche un tableau croisé avec le nombre d'observations pour deux variables discrètes et les médianes avec l'intervalle interquartile pour une variable discrète croisée avec une variable continue.
