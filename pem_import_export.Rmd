...
<strong class="pkg">readr</strong>. Elle permet notamment de spécifier les colonnes
...
d'une extension nommée <strong class="pkg">foreign</strong>, installée par défaut avec **R** mais 
...
`read.xport`{data-package="foreign"} de l'extension <strong class="pkg">foreign</strong>.
...
`read_sas`{data-package="haven"} de l'extension <strong class="pkg">haven</strong>.
...
Il existe des alternatives comme `read.ssd`{data-package="foreign"} de l'extension <strong class="pkg">foreign</strong> et `sas.get` de l'extension <strong class="pkg">Hmisc</strong>,
...
avec la fonction `read.spss`{data-package="foreign"} de l'extension <strong class="pkg">foreign</strong>.
...
<strong class="pkg">JLutils</strong>, disponible sur <https://github.com/larmarange/JLutils>,
...
<strong class="pkg">foreign</strong> ne sait pas importer les dates. Ces dernières
...
Si l'on utilise l'extension <strong class="pkg">haven</strong>, 
...
<strong class="pkg">haven</strong> a fait le choix de ne pas convertir
...
Pour le moment, la version 0.2.0 de <strong class="pkg">haven</strong>
...
<strong class="pkg">sjmisc</strong> et <strong class="pkg">sjPlot</strong>.

Enfin, concernant l'import de fichiers **SPSS**, on pourra aussi avoir recours à la fonction 
`spss.get`{data-package="Hmisc"} de l'extension <strong class="pkg">Hmisc</strong>.
...
Enfin, <strong class="pkg">Hmisc</strong> propose une fonction `stata.get`{data-package="Hmisc"}.
...
L'extension <strong class="pkg">readxl</strong> fournit une fonction 
...
L'extension <strong class="pkg">xlsx</strong> propose deux fonctions
...
de l'extension <strong class="pkg">foreign</strong>.
...
L'extension <strong class="pkg">maptools</strong> fournit les fonctions permettant d'importer
un **shapefile** dans **R**. Le résultat obtenu utilisera l'une des différentes classes spatiales
fournies par l'extension <strong class="pkg">sp</strong>.
...
`readAsciiGrid`{data-package="maptools"} de l'extension <strong class="pkg">maptools</strong>.
...
l'extension <strong class="pkg">sp</strong>.
...
L'extension <strong class="pkg">raster</strong> permet d'effectuer
...
plusieurs Go de données), l'extension <strong class="pkg">raster</strong>
...
|:---|:---|:---|
| texte | `write.table`{data-package="utils"} | <strong class="pkg">utils</strong> |
| CSV | `write.csv`{data-package="utils" data-rdocumentation="write.table"} | <strong class="pkg">utils</strong> |
| CSV | `write_csv`{data-package="readr"} | <strong class="pkg">readr</strong> |
| Excel | `write.xlsx`{data-package="xlsx"} | <strong class="pkg">xlsx</strong> |
| dBase | `write.dbf`{data-package="foreign"} | <strong class="pkg">foreign</strong> |
| SPSS | `write_sav`{data-package="haven"} | <strong class="pkg">haven</strong> |
| SPSS | `write.foreign`{data-package="foreign"} | <strong class="pkg">foreign</strong> |
| Stata | `write.dta`{data-package="foreign"} | <strong class="pkg">foreign</strong> |
| Stata | `write_dta`{data-package="haven"} | <strong class="pkg">haven</strong> |
| SAS | `write.foreign`{data-package="foreign"} | <strong class="pkg">foreign</strong> |
| SPSS | `write.foreign`{data-package="foreign"} | <strong class="pkg">foreign</strong> |
| Shapefile | `writePointsShape`{data-package="maptools" data-rdocumentation="readShapePoints"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writeLinesShape`{data-package="maptools" data-rdocumentation="readShapeLines"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writePolyShape`{data-package="maptools" data-rdocumentation="readShapePoly"} | <strong class="pkg">maptools</strong> |
| ASCII Grid | `writeAsciiGrid`{data-package="maptools" data-rdocumentation="readAsciiGrid"} | <strong class="pkg">maptools</strong> |
