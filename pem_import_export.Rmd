...
| CSV | `write.csv`{data-pkg="utils" data-rdoc="write.table"} | <strong class="pkg">utils</strong> |
...
| SPSS | `write.foreign`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| Shapefile | `writePointsShape`{data-pkg="maptools" data-rdoc="readShapePoints"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writeLinesShape`{data-pkg="maptools" data-rdoc="readShapeLines"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writePolyShape`{data-pkg="maptools" data-rdoc="readShapePoly"} | <strong class="pkg">maptools</strong> |
| ASCII Grid | `writeAsciiGrid`{data-pkg="maptools" data-rdoc="readAsciiGrid"} | <strong class="pkg">maptools</strong> |
