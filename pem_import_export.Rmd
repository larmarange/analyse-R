...
|:---|:--:|:--:|:--:|
| `read.csv`{data-pkg="utils" data-rdocumentation="read.table"} | virgule | point | doubles |
| `read.csv2`{data-pkg="utils" data-rdocumentation="read.table"} | point-virgule | point | doubles |
| `read.delim`{data-pkg="utils" data-rdocumentation="read.table"} | tabulation | point | doubles |
| `read.delim2`{data-pkg="utils" data-rdocumentation="read.table"} | tabulation | virgule | doubles |
...
`read.xport`{data-pkg="foreign"} de l'extension <strong class="pkg">foreign</strong>.
...
`read_sas`{data-pkg="haven"} de l'extension <strong class="pkg">haven</strong>.
...
Il existe des alternatives comme `read.ssd`{data-pkg="foreign"} de l'extension <strong class="pkg">foreign</strong> et `sas.get` de l'extension <strong class="pkg">Hmisc</strong>,
...
avec la fonction `read.spss`{data-pkg="foreign"} de l'extension <strong class="pkg">foreign</strong>.
...
`read_sav`{data-pkg="haven" data-rdocumentation="read_spss"} et
`read_por`{data-pkg="haven" data-rdocumentation="read_spss"}, on notera que 
...
`as_factor`{data-pkg="haven" data-rdocumentation="labelled"} (avec un tiret bas et non un point).
...
`spss.get`{data-pkg="Hmisc"} de l'extension <strong class="pkg">Hmisc</strong>.
...
`read_dta`{data-pkg="haven"} et `read_stata`{data-pkg="haven" data-rdocumentation="read_dta"}.
...
Enfin, <strong class="pkg">Hmisc</strong> propose une fonction `stata.get`{data-pkg="Hmisc"}.
...
et `read.xlsx2`{data-pkg="xlsx" data-rdocumentation="read.xlsx"}. La finalité
...
`readAsciiGrid`{data-pkg="maptools"} de l'extension <strong class="pkg">maptools</strong>.
Le résultat sera, par défaut, au format 
`SpatialGridDataFrame`{data-pkg="sp" data-rdocumentation="SpatialGridDataFrame-class"} de
...
La fonction `save.image`{data-pkg="base" data-rdocumentation="save"} est un raccourci pour sauvergarder 
...
`save.image`{data-pkg="base" data-rdocumentation="save"} qui sera appliquée.
...
|:---|:---|:---|
| texte | `write.table`{data-pkg="utils"} | <strong class="pkg">utils</strong> |
| CSV | `write.csv`{data-pkg="utils" data-rdocumentation="write.table"} | <strong class="pkg">utils</strong> |
| CSV | `write_csv`{data-pkg="readr"} | <strong class="pkg">readr</strong> |
| Excel | `write.xlsx`{data-pkg="xlsx"} | <strong class="pkg">xlsx</strong> |
| dBase | `write.dbf`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| SPSS | `write_sav`{data-pkg="haven"} | <strong class="pkg">haven</strong> |
| SPSS | `write.foreign`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| Stata | `write.dta`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| Stata | `write_dta`{data-pkg="haven"} | <strong class="pkg">haven</strong> |
| SAS | `write.foreign`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| SPSS | `write.foreign`{data-pkg="foreign"} | <strong class="pkg">foreign</strong> |
| Shapefile | `writePointsShape`{data-pkg="maptools" data-rdocumentation="readShapePoints"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writeLinesShape`{data-pkg="maptools" data-rdocumentation="readShapeLines"} | <strong class="pkg">maptools</strong> |
| Shapefile | `writePolyShape`{data-pkg="maptools" data-rdocumentation="readShapePoly"} | <strong class="pkg">maptools</strong> |
| ASCII Grid | `writeAsciiGrid`{data-pkg="maptools" data-rdocumentation="readAsciiGrid"} | <strong class="pkg">maptools</strong> |
