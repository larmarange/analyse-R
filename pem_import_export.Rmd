...
<strong class="package">readr</strong>. Elle permet notamment de spécifier les colonnes
...
`read_sas`{data-package="haven"} de l'extension <strong class="package">haven</strong>.
...
Il existe des alternatives comme `read.ssd`{data-package="foreign"} de l'extension <strong class="package">foreign</strong> et `sas.get` de l'extension <strong class="package">Hmisc</strong>,
...
avec la fonction `read.spss`{data-package="foreign"} de l'extension <strong class="package">foreign</strong>.
...
Il est important de noter que `read.spss`{data-package="foreign"} de l'extension 
<strong class="package">foreign</strong> ne sait pas importer les dates. Ces dernières
...
Si l'on utilise l'extension <strong class="package">haven</strong>, 
à l'aide des fonctions `read_spss`{data-package="haven"}, 
`read_sav`{data-package="haven" data-rdocumentation="read_spss"} et
`read_por`{data-package="haven" data-rdocumentation="read_spss"}, on notera que 
<strong class="package">haven</strong> a fait le choix de ne pas convertir
...
Pour le moment, la version 0.2.0 de <strong class="package">haven</strong>
