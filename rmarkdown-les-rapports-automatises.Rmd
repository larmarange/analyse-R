...
<figcaption>Position de l'icône *compile report*<figcaption>
</figure>
...
Pour une présentation plus avancée, on pourra également avoir recours à l'extenstion `gtsummary`{.pkg} et aux fonctions `tbl_summary`{data-pkg="gtsummary"}, `tbl_svysummary`{data-pkg="gtsummary"} et `tbl_regression`{data-pkg="gtsummary"}.
