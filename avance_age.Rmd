...
de type `Interval`{data-pkg="lubridate" data-rdocumentation="Interval-class"}. 
...
un objet de type `Interval`{data-pkg="lubridate" data-rdocumentation="Interval-class"} 
(pour lequel on connait dès lors la date de début et la date de fin). 
Si l'on passe une durée (objet de type `Duration`{data-pkg="lubridate" data-rdocumentation="Duration-class"})
...
`Period`{data-pkg="lubridate" data-rdocumentation="Period-class"} et à ne prendre en compte que les années.
