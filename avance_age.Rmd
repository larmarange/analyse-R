...
Le package <strong class="pkg">lubridate</strong> est spécialement développé pour faciliter la manipulation 
...
Pour installer la version de développement de <strong class="pkg">lubridate</strong>,
on aura recours au package <strong class="pkg">devtools</strong> :
...
Le package <strong class="pkg">eeptools</strong> fournit de son côté une fonction 
...
d'utiliser de préférence le package <strong class="pkg">lubridate</strong>.

En l'absence du package <strong class="pkg">lubridate</strong>, il reste facile de calculer 
