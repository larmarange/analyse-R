...
de l'extension <strong class="package">questionr</strong> :
...
<div class="info">
Si l'on a importé nos données depuis **SPSS** ou **Stata** avec l'extension <strong class="package">haven</strong>,
...
<strong class="package">JLutils</strong> qui fonctionne également si les données ont été importées
avec `read.spss`{data-package="foreign"} ou `read.dta`{data-package="foreign"} de l'extension
<strong class="package">foreign</strong> sans avoir converti les variables labelisées en facteurs.
</div>
...
Si vous disposez de l'extension <strong class="package">questionr</strong>, la fonction `odds.ratio`{data-pacakge="questionr"} permet de calculer directement les *odds ratio*, 
