...
`dev.print`{data-pkg="grDevices" data-rdocumentation="dev2"}. On doit fournir à celle-ci le format de 
...
`jpeg`{data-pkg="grDevices" data-rdocumentation="png"} et
`tiff`{data-pkg="grDevices" data-rdocumentation="png"} pour les formats *bitmap*, 
`svg`{data-pkg="grDevices" data-rdocumentation="cairo"},
`pdf`{data-pkg="grDevices"}, `postscript`{data-pkg="grDevices"} et
`win.metafile`{data-pkg="grDevices" data-rdocumentation="windows"} pour les formats vectoriels.
...
Il est nécessaire de faire un appel à la fonction `dev.off`{data-pkg="grDevices" data-rdocumentation="dev"} 
