...
Les pourcentages lignes s'obtiennent avec la fonction `lprop`{data-pkg="questionr"data-rdocumentation="rprop"}^[Il 
...
`print`{data-pkg="questionr" data-rdocumentation="print.proptab"} :
...
`chisq.residuals`{data-pkg="questionr"} de <strong class="pkg">questionr</strong> :
...
`cramer.v`{data-pkg="questionr"} de <strong class="pkg">questionr</strong> :
...
L'extension <strong class="pkg">vcd</strong> fournie une fonction `mosaic`{data-pkg="vcd"}
...
`relrisk`{data-pkg="mosaic"} de l'extension <strong class=""package>mosaic</strong>.
