...
Plus sophistiqué, on peut faire une <dfn>estimation locale de densité</dfn><dfn data-index="densité, estimation locale">
...
<dfn>test du &chi;²</dfn><dfn data-index="&chi;², test"></dfn><dfn data-index="chi-2, cf. &chi;²"></dfn>^[On ne
...
L'extension <strong class="package">vcd</strong> fournie une fonction `mosaic`{data-package="vcd"}
...
<strong class="package">questionr</strong> qui réalise le même calcul mais présente le
