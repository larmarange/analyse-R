...
À première vue, ô surprise, la population écoutant du hard rock a l'air sensiblement plus jeune. Peu-ton
le tester mathématiquement ? On peut calculer la moyenne d'âge des deux groupes en utilisant la
