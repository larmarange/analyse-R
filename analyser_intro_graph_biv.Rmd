...
Les graphiques produits par `ggplot2`{.pkg} peuvent être sauvegardés manuellement, comme expliqué dans le chapitre <q>[Exporter des graphiques](manipuler_pem_export_graph.html)</q>, ou programmatiquement. Pour sauvegarder le dernier graphique affiché par `ggplot2`{.pkg} au format PNG, il suffit d'utiliser la fonction `ggsave`{data-pkg="ggplot2" data-rdoc="ggsave"}, qui permet d'en régler la taille (en pouces) et la résolution (en pixels par pouce ; 72 par défaut) :
