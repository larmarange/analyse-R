...
```{r, warning=FALSE}
library(labelled)
v <- labelled(c(1,2,9,3,3,2,NA), c(oui = 1, "peut-être" = 2, non = 3, "ne sait pas" = 9), c(FALSE, FALSE, FALSE, TRUE))
v
to_factor(v)
```
...
L'argument `missing_to_na` permets d'indiquer si les valeurs définies comme manquantes doivent être converties en `NA`.
