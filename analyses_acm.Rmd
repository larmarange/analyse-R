...
`screeplot`{data-pkg="ade4" data-rdocumentation="scatter"} :
...
`summary`{data-pkg="ade4" data-rdocumentation="dudi"}^[On pourra également avoir recours à la 
...
On pourra avoir également recours à `boxplot`{data-pkg="ade4" data-rdocumentation="dudi.acm"}
pour visualiser comment se répartissent les modalités
de chaque variable sur un axe donné^[La fonction `score`{data-pkg="ade4" data-rdocumentation="score.acm"}
...
`display.brewer.all`{data-pkg="RColorBrewer" data-rdocumentation="RColorsBrewer"}.
...
`brewer.pal`{data-pkg="RColorBrewer" data-rdocumentation="RColorsBrewer"} avec les arguments
...
`biplot`{data-pkg="ade4" data-rdocumentation="scatter"} sont équivalentes :
...
`plot`{data-pkg="FactoMineR" data-rdocumentation="plot.MCA"} affichera par défaut les individus, 
