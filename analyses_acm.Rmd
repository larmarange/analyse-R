...
d'avoir recours à deux autres extensions plus complètes, <strong class="pkg">ade4</strong>
et <strong class="pkg">FactoMineR</strong>, chacune ayant ses avantages et des possibilités différentes. Voici les fonctions les plus fréquentes :

| Analyse | Variables | Fonction standard | Fonction <strong class="pkg">ade4</strong> | Fonctions <strong class="pkg">FactoMineR</strong> |
|:--------|:----------|:-----------------:|:----------------------------------------:|:--------:|
...
Si l'extension <strong class="pkg">ade4</strong> n'est pas présente sur votre PC, 
...
<strong class="pkg">questionr</strong>.
...
Le package <strong class="pkg">JLutils</strong>, disponible seulement sur 
...
graphiques de <strong class="pkg">ade4</strong>. Le paramètre `csize` permet d'ajuster 
...
lisible. Si vous avez installé l'extension <strong class="pkg">RColorBrewer</strong>, vous pouvez 
...
Comme avec <strong class="pkg">ade4</strong>, il est nécessaire de préparer les données au préalable 
...
Les possibilités graphiques de <strong class="pkg">FactoMineR</strong> sont différentes de celles de 
<strong class="pkg">ade4</strong>. Un recours à la fonction 
