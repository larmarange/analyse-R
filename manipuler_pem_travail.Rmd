...
[chapitre](manipuler_pem_import.html)), il s'agira souvent de vérifier que l'importation s'est bien déroulée.
...
L'extension `questionr`{.pkg} propose également une fonction `lookfor`{data-pkg="questionr"}
...
cas la fonction `describe`{data-pkg="questionr"} (voir ci-après), cependant moins générique puisque ne s'appliquant
...
<div class="note">
L'extension `dplyr`{.pkg}, que nous n'aborderons en détails que plus tard, propose une fonction
