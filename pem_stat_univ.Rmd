...
fournies avec l'extension <strong class="pkg">questionr</strong>.
...
`freq`{data-package="questionr"} de l'extension <strong class="pkg">questionr</strong>^[En 
l'absence de l'extension <strong class="pkg">questionr</strong>, on pourra se rabattre sur la 
...
<div class="astuce">
Pour se simplifier un peu la vie, le package <strong class="pkg">JLutils</strong> propose
...
<strong class="pkg">JLutils</strong> n'étant disponible que sur
