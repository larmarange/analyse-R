...
`min`{data-pkg="base" data-rdocumentation="Extremes"} (<dfn>minimum</dfn>),
`max`{data-pkg="base" data-rdocumentation="Extremes"} (<dfn>maximum</dfn>) 
...
`freq`{data-pkg="questionr"} de l'extension <strong class="pkg">questionr</strong>^[En 
...
`plot`{data-pkg="graphics" data-rdocumentation="plot.table"} à un tri à plat obtenu avec 
...
d'où l'appel à la fonction `as.matrix`{data-pkg="base" data-rdocumentation="matrix"}.] :
...
à la fonction `as.matrix`{data-pkg="base" data-rdocumentation="matrix"}.
...
`as.matrix`{data-pkg="base" data-rdocumentation="matrix"} a produit un objet
...
l'appel à `as.matrix`{data-pkg="base" data-rdocumentation="matrix"}).
