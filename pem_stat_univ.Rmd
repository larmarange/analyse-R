...
<figure>
```{r}
dotchart(as.matrix(table(d$clso)), main = "Sentiment d'appartenance à une classe sociale", pch = 19)
```
...
<figure>
```{r}
dotchart(as.matrix(sort(table(d$qualif))), main = "Niveau de qualification")
```
