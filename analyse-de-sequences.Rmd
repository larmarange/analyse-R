...
<div class="important">
Ce cas de figure où tous les coûts de substitution sont égaux à 2 et le coût *indel* égal à 1 correspond à un cas particulier d'*optimal matching* que l'on appelle la <dfn lang="en">Longuest Common Subsequence</dfn> ou <dfn>LCS</df>. Elle peut se calculer directement avec `seqdist` de la manière suivante :
