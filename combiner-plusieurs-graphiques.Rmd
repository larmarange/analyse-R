...
L'extension `cowplot`{.pkg} propose une fonction `plot_grid`{data-pkg="cowplot"}. Son usage est expliqué en détail dans la vignette dédiée inclue avec l'extension : <https://cran.r-project.org/web/packages/cowplot/vignettes/plot_grid.html>.
