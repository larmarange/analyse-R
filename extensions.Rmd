...
la plupart s'intègre parfaitement avec **RStudio**. On nomme un peu familièrement 
<q>Hadleyverse</q> l'ensemble constitué par les différentes extensions crées par Hadley Wickham.
