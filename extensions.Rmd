...
<q>tidyverse</q> et est développé sur GitHub : <https://github.com/tidyverse/>. Une présentation 
plus générale du <q>tidyverse</q> est disponible sur le site de RStudio : <https://www.rstudio.com/products/rpackages/>.
...
les extensions du <q>tidyverse</q>, en particulier `haven`{.pkg}, `readr`{.pkg} et
