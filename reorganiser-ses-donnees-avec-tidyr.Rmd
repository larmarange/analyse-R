...
<div class="guide-R">
Une version actualisée de ce chapitre est disponible sur **guide-R** : [Réorganisation avec tidyr](https://larmarange.github.io/guide-R/manipulation_avancee/tidyr.html)
</div>
...
```{r}
df %>% tidyr::extract(eleve, c("prenom", "nom"), "^(.*) (.*)$")
```
