...
Comme indiqué dans l'[introduction au tidyverse](introduction-au-tidyverse.html#tidydata), les extensions du **tidyverse** comme `dplyr`{.pkg} ou `ggplot2`{.pkg} partent du principe que les données sont "bien rangées" sous forme de *tidy data*.
