...
`?`{data-pkg="utils" data-rdocumentation="Question"}) qui permet d'afficher la page d'aide liée à une ou 
...
`help.search`{data-pkg="utils"} (ou `??`{data-pkg="utils" data-rdocumentation="help.search"} qui 
