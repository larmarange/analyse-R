...
Il est possible de sélectionner des variables à la manière de <strong class="pkg">dplyr</strong>. Voir l'aide de `contains`{data-pkg="dplyr" data-rdoc="select_helpers"}.
